                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td><?= $d['status'] == 1 ? 'Sudah Lunas' : 'Belum Lunas' ?></td>
                      <td>    

                     


                      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#bayar_hutang_<?php echo $d['hutang_id'] ?>">
                      ...
                      <form action="bayar_hutang.php" method="post">
                        <div class="modal fade" id="bayar_hutang_<?php echo $d['hutang_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLabel">Bayar hutang</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                ...
                                <div class="form-group" style="width:100%;margin-bottom:20px">
                                  ...
                                  <input type="hidden" name="id" value="<?php echo $d['hutang_id'] ?>">
                                  <input type="text" style="width:100%" name="tanggal" required="required" class="form-control datepicker2"  value="<?php echo date('Y-m-d') ?>">
                                </div>
